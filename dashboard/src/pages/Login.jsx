      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          <div style={{ marginTop: '8px' }}>
            <span style={{ color: '#fff', fontWeight: 700, fontSize: '20px', letterSpacing: '-0.02em' }}>OBDesign</span>
            <span style={{ color: '#7ba49e', fontWeight: 400, fontSize: '16px', marginLeft: '7px' }}>CMS</span>
          </div>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          <button
            ...
            style={{
              ...
              background: loading ? 'rgba(123,164,158,0.35)' : '#7ba49e',
              color: '#0b1f1d', border: 'none', borderRadius: '10px',
              fontSize: '12px', fontWeight: 900, textTransform: 'uppercase',
              letterSpacing: '0.08em', cursor: loading ? 'default' : 'pointer',
              transition: 'transform 0.15s, box-shadow 0.15s, background 0.15s',
              boxShadow: loading ? 'none' : '0 0 24px rgba(123,164,158,0.28)',
            }}
            onMouseEnter={e => { if (!loading) e.currentTarget.style.transform = 'scale(1.025)'; }}
